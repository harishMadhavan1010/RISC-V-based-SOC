...
`include "sp_verilog.vh" //_\SV
   ...
   // Included URL: "https://raw.githubusercontent.com/stevehoover/RISC-V_MYTH_Workshop/ecba3769fff373ef6b8f66b3347e8940c859792d/tlv_lib/risc-v_shell_lib.tlv"// Included URL: "https://raw.githubusercontent.com/stevehoover/warp-v_includes/2d6d36baa4d2bc62321f982f78c8fe1456641a43/risc-v_defs.tlv"

//_\SV
   module top(input wire clk, input wire reset, input wire [31:0] cyc_cnt, output wire passed, output wire failed);    /* verilator lint_save */ /* verilator lint_off UNOPTFLAT */  bit [256:0] RW_rand_raw; bit [256+63:0] RW_rand_vect; pseudo_rand #(.WIDTH(257)) pseudo_rand (clk, reset, RW_rand_raw[256:0]); assign RW_rand_vect[256+63:0] = {RW_rand_raw[62:0], RW_rand_raw};  /* verilator lint_restore */  /* verilator lint_off WIDTH */ /* verilator lint_off UNOPTFLAT */   // (Expanded in Nav-TLV pane.)
`include "mythcore_gen.v"
generate //_\TLV
   ...
   // Load-Store:
   // Inst #8: SW,r0,r10,100             // Store the value in the Data Memory
   // Inst #9: LW,r15,r0,100             // Load the stored value in the x15 of RegFile
   // Inst #10: SW,r1,r10,1000            // To verify if load instruction works (TEST)
   // Inst #11: SW,r2,r10,1100            // To verify if load instruction works (TEST)
   
   // Optional:
   // Inst #12: JAL,r7,00000000000000000000 // Done. Jump to itself (infinite loop). (Up to 20-bit signed immediate plus implicit 0 bit (unlike JALR) provides byte address; last immediate bit should also be 0)
   ...
   //_|cpu
      //_@0
         ...
         // Program Counter
         assign CPU_pc_a0[31:0] = CPU_reset_a1 ? 32'0 :
      ...
      //_@1
         ...
         assign CPU_is_r_instr_a1 = CPU_instr_a1[6:2] ==? 5'b011x0 |
         ...
         assign CPU_imm_a1[31:0] = CPU_is_i_instr_a1 ? { {21{CPU_instr_a1[31]}}, CPU_instr_a1[30:20] } :
                ...
                CPU_is_u_instr_a1 ? { CPU_instr_a1[31], CPU_instr_a1[30:12], {12{1'b0}} } :
      ...
      //_@1
         ...
         assign CPU_is_jalr_a1 = CPU_dec_bits_a1 ==? 11'bx_xxx_1100111;
         ...
         assign CPU_is_sub_a1 = CPU_dec_bits_a1 ==? 11'b1_000_0010011;
         assign CPU_is_sll_a1 = CPU_dec_bits_a1 ==? 11'b0_001_0010011;
         assign CPU_is_slt_a1 = CPU_dec_bits_a1 ==? 11'b0_010_0010011;
         assign CPU_is_sltu_a1 = CPU_dec_bits_a1 ==? 11'b0_011_0010011;
         assign CPU_is_xor_a1 = CPU_dec_bits_a1 ==? 11'b0_100_0010011;
         assign CPU_is_srl_a1 = CPU_dec_bits_a1 ==? 11'b0_101_0010011;
         assign CPU_is_sra_a1 = CPU_dec_bits_a1 ==? 11'b1_101_0010011;
         assign CPU_is_or_a1 = CPU_dec_bits_a1 ==? 11'b0_110_0010011;
         assign CPU_is_and_a1 = CPU_dec_bits_a1 ==? 11'b0_111_0010011;
         
      //_@2
         // Register File Read
         //_?$rs1_valid
            assign CPU_rf_rd_en1_a2 = 1'b1;
            assign CPU_rf_rd_index1_a2[4:0] = CPU_rs1_a2;
            assign CPU_src1_value_a2[31:0] = (CPU_rd_a3 == CPU_rs1_a2 & CPU_rf_wr_en_a3) ? CPU_result_a3 : CPU_rf_rd_data1_a2;
            
         //_?$rs2_valid
            assign CPU_rf_rd_en2_a2 = 1'b1;
            assign CPU_rf_rd_index2_a2[4:0] = CPU_rs2_a2;
            assign CPU_src2_value_a2[31:0] = (CPU_rd_a3 == CPU_rs2_a2 & CPU_rf_wr_en_a3) ? CPU_result_a3 : CPU_rf_rd_data2_a2;
         
         // Branch Target PC
         assign CPU_br_tgt_pc_a2[31:0] = CPU_imm_a2 + CPU_pc_a2;
      ...
      //_@3
         ...
         assign CPU_result_a3[31:0] = CPU_is_add_a3 ? CPU_src2_value_a3 + CPU_src1_value_a3 :
                         CPU_is_sub_a3 ? CPU_src2_value_a3 - CPU_src1_value_a3 :
         ...
         // Register File Write
         assign CPU_dest_not_zero_a3 = ! CPU_rd_a3 ==? 5'b00000;
         assign CPU_write_valid_a3 = CPU_rd_valid_a3 & CPU_dest_not_zero_a3 & CPU_valid_a3;
         assign CPU_rf_wr_en_a3 = (CPU_valid_jump_a3 ^ CPU_valid_load_a3 ^ CPU_write_valid_a3) || CPU_valid_load_a5;
         ...
         assign CPU_taken_br_a3 = (CPU_is_beq_a3 ? (CPU_src1_value_a3 == CPU_src2_value_a3) :
                     ...
                     CPU_is_bge_a3 ? (CPU_src1_value_a3 >= CPU_src2_value_a3) ^ (CPU_src1_value_a3[31] ^ CPU_src1_value_a3[31]) :
         ...
         assign CPU_valid_a3 = ! (CPU_reset_a3 || CPU_valid_taken_br_a4 || CPU_valid_taken_br_a5 || CPU_valid_load_a4 || CPU_valid_load_a5 || CPU_valid_jump_a4 || CPU_valid_jump_a5);
         assign CPU_valid_load_a3 = CPU_is_load_a3 & CPU_valid_a3;
         assign CPU_valid_jump_a3 = (CPU_is_jal_a3 | CPU_is_jalr_a3) & CPU_valid_a3;
   ...
   //  o CPU visualization
   //_|cpu
      //_\source /raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/ecba3769fff373ef6b8f66b3347e8940c859792d/tlvlib/riscvshelllib.tlv 16   // Instantiated from mythcore_test.tlv, 254 as: m4+imem(@1)
         // Instruction Memory containing program defined by m4_asm(...) instantiations.
         //_@1
            /*SV_plus*/
               // The program in an instruction memory.
               logic [31:0] instrs [0:13-1];
               assign instrs = '{
                  {7'b0000000, 5'd0, 5'd0, 3'b000, 5'd10, 7'b0110011}, {7'b0000000, 5'd0, 5'd10, 3'b000, 5'd14, 7'b0110011}, {12'b1010, 5'd10, 3'b000, 5'd12, 7'b0010011}, {7'b0000000, 5'd0, 5'd10, 3'b000, 5'd13, 7'b0110011}, {7'b0000000, 5'd14, 5'd13, 3'b000, 5'd14, 7'b0110011}, {12'b1, 5'd13, 3'b000, 5'd13, 7'b0010011}, {1'b1, 6'b111111, 5'd12, 5'd13, 3'b100, 4'b1100, 1'b1, 7'b1100011}, {7'b0000000, 5'd0, 5'd14, 3'b000, 5'd10, 7'b0110011}, {7'b0000000, 5'd10, 5'd0, 3'b010, 5'b00100, 7'b0100011}, {12'b100, 5'd0, 3'b010, 5'd15, 7'b0000011}, {7'b0000000, 5'd10, 5'd1, 3'b010, 5'b01000, 7'b0100011}, {7'b0000000, 5'd10, 5'd2, 3'b010, 5'b01100, 7'b0100011}, {1'b0, 10'b0000000000, 1'b0, 8'b00000000, 5'd7, 7'b1101111}
               };
      ...
      //_\source /raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/ecba3769fff373ef6b8f66b3347e8940c859792d/tlvlib/riscvshelllib.tlv 33   // Instantiated from mythcore_test.tlv, 255 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      //_\source /raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/ecba3769fff373ef6b8f66b3347e8940c859792d/tlvlib/riscvshelllib.tlv 50   // Instantiated from mythcore_test.tlv, 256 as: m4+dmem(@4)
         // Data Memory
         //_@4
   ...
   //_\source /raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/ecba3769fff373ef6b8f66b3347e8940c859792d/tlvlib/riscvshelllib.tlv 63   // Instantiated from mythcore_test.tlv, 258 as: m4+cpu_viz(@4)
      
      //_|cpu
         // for pulling default viz signals into CPU
         // and then back into viz
         //_@0
            assign {CPU_dummy_a0[0:0], CPU_is_csrrc_a0, CPU_is_csrrci_a0, CPU_is_csrrs_a0, CPU_is_csrrsi_a0, CPU_is_csrrw_a0, CPU_is_csrrwi_a0, CPU_is_lb_a0, CPU_is_lbu_a0, CPU_is_lh_a0, CPU_is_lhu_a0, CPU_is_lw_a0, CPU_is_store_a0} = {CPUVIZ_Defaults_dummy_a0, CPUVIZ_Defaults_is_csrrc_a0, CPUVIZ_Defaults_is_csrrci_a0, CPUVIZ_Defaults_is_csrrs_a0, CPUVIZ_Defaults_is_csrrsi_a0, CPUVIZ_Defaults_is_csrrw_a0, CPUVIZ_Defaults_is_csrrwi_a0, CPUVIZ_Defaults_is_lb_a0, CPUVIZ_Defaults_is_lbu_a0, CPUVIZ_Defaults_is_lh_a0, CPUVIZ_Defaults_is_lhu_a0, CPUVIZ_Defaults_is_lw_a0, CPUVIZ_Defaults_is_store_a0};
      ...
      /*SV_plus*/
         logic [40*8-1:0] instr_strs [0:13];
         assign instr_strs = '{ "(R) ADD r10,r0,r0                       ",  "(R) ADD r14,r10,r0                      ",  "(I) ADDI r12,r10,1010                   ",  "(R) ADD r13,r10,r0                      ",  "(R) ADD r14,r13,r14                     ",  "(I) ADDI r13,r13,1                      ",  "(B) BLT r13,r12,1111111111000           ",  "(R) ADD r10,r14,r0                      ",  "(S) SW r0,r10,100                       ",  "(I) LW r15,r0,100                       ",  "(S) SW r1,r10,1000                      ",  "(S) SW r2,r10,1100                      ",  "(J) JAL r7,00000000000000000000         ",  "END                                     "};
      //_|cpuviz
         //_@1
            for (imem = 0; imem <= 12; imem=imem+1) begin : L1_CPUVIZ_Imem //_/imem
